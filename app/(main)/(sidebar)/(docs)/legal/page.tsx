...
export const metadata: Metadata = {
  title: "Legal",
  description: "Terms of Service, Privacy Policy, and Content Guidelines for YourApp.",
};
        ...
        >
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold">3. Content Responsibility</h3>
                <p className="text-gray-300 leading-relaxed">
                  You are responsible for any content (photos, videos, posts)
                  uploaded. Illegal, harmful, explicit, or infringing
