...
//         {/* CARD like Legal */}
//         <div className="bg-white/5 border border-white/10 rounded-xl p-8 space-y-10">
//           {/* ================= HEADER ================= */}
//           <section>
//             <h2 className="text-3xl font-bold tracking-wide">
//               RIZKY OCTA <br /> ARINDA
//             </h2>
//           </section>
...
//               <li>📍 Indonesia, Pekanbaru (Riau)</li>
//             </ul>
//           </section>
...
//           {/* ================= ABILITY ================= */}
//           <section>
//             <h3 className="text-xl font-semibold mb-3">Ability</h3>
...
//               <div>
//                 <h4 className="font-semibold text-sm">Qonqar Store | 5 Month</h4>
//                 <ul className="list-disc ml-5 text-sm text-gray-300">
